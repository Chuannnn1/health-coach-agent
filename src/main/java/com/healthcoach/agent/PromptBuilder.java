...
public class PromptBuilder {
    ...
    private static final String PATCH_INSTRUCTIONS = ""
            ...
            + "## <PATCH> — 刪除用餐紀錄\n\n"
            + "target \"daily_log\"，action \"remove_meal\"，value 為今日紀錄中的 0-based 索引。\n"
            + "使用者說「刪掉第二筆」或「多記了一筆」時，先用 /today 顯示的順序對應索引。\n"
            + "範例（刪除第 2 筆，index=1）：<PATCH>{\"target\":\"daily_log\",\"action\":\"remove_meal\",\"value\":1}</PATCH>\n\n"
            + "## 使用原則\n\n"
